...
class SPVCNN(Res16UNet34C):
    def network_initialization(self, in_channels, out_channels, D):
        ...
        self.final = nn.Linear(self.PLANES[7] * self.BLOCK.expansion, out_channels)
        ...
        self.point_transforms = nn.ModuleList([
            ...
            nn.Sequential(
                ...
                ME.MinkowskiReLU(True)
                # nn.Linear(self.PLANES[4], self.PLANES[5]),
                # nn.BatchNorm2d(self.PLANES[5]),
                # nn.ReLU(True)
            ),
            nn.Sequential(
    ...
    ## to modify, but may not need to run spvcnn
