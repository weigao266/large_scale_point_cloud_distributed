...
class TnnLayer(nn.Module):
    def __init__(self, dim, num_heads, rpe_embedding, glu_dim,
        # model params
        prenorm=True, norm_type="simplermsnorm",
        # gtu params
        causal=False, gtu_act="silu", expand_ratio=3, use_decay=True, gamma=0.999,
        # rpe params
        rpe_act="relu", rpe_layers=3,
        # glu params
        glu_act="silu",
    ):
        super().__init__()
